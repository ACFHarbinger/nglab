...
def has_default_client_cert_source(): # -> bool:
...
def default_client_cert_source(): # -> Callable[[], tuple[Any | None, Any | None]]:
...
def default_client_encrypted_cert_source(cert_path, key_path): # -> Callable[[], tuple[Any, Any, Any | None]]:
