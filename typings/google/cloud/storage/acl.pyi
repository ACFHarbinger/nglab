...
class ACL:
    ...
    @classmethod
    def validate_predefined(cls, predefined):  # -> str | None:
    ...
    def entity(self, entity_type, identifier=...):  # -> _ACLEntity | None:
    ...
    def user(self, identifier):  # -> _ACLEntity | None:
    ...
    def group(self, identifier):  # -> _ACLEntity | None:
    ...
    def domain(self, domain):  # -> _ACLEntity | None:
    ...
    def all_authenticated(self):  # -> _ACLEntity | None:
