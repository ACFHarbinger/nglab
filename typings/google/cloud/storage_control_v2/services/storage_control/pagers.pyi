...
class ListFoldersPager:
    ...
    """
    def __init__(self, method: Callable[..., storage_control.ListFoldersResponse], request: storage_control.ListFoldersRequest, response: storage_control.ListFoldersResponse, *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
...
class ListFoldersAsyncPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., Awaitable[storage_control.ListFoldersResponse]], request: storage_control.ListFoldersRequest, response: storage_control.ListFoldersResponse, *, retry: OptionalAsyncRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
...
class ListManagedFoldersPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., storage_control.ListManagedFoldersResponse], request: storage_control.ListManagedFoldersRequest, response: storage_control.ListManagedFoldersResponse, *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
        """Instantiate the pager.
...
class ListManagedFoldersAsyncPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., Awaitable[storage_control.ListManagedFoldersResponse]], request: storage_control.ListManagedFoldersRequest, response: storage_control.ListManagedFoldersResponse, *, retry: OptionalAsyncRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
        """Instantiates the pager.
...
class ListAnywhereCachesPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., storage_control.ListAnywhereCachesResponse], request: storage_control.ListAnywhereCachesRequest, response: storage_control.ListAnywhereCachesResponse, *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
        """Instantiate the pager.
...
class ListAnywhereCachesAsyncPager:
    ...
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self, method: Callable[..., Awaitable[storage_control.ListAnywhereCachesResponse]], request: storage_control.ListAnywhereCachesRequest, response: storage_control.ListAnywhereCachesResponse, *, retry: OptionalAsyncRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, Union[str, bytes]]] = ...) -> None:
        """Instantiates the pager.
