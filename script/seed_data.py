...
def main():
    ...
    parser.add_argument("--assets", type=str, default="BTC,ETH,SOL", help="Comma-separated list of assets")
    parser.add_argument("--days", type=int, default=7, help="Number of days to generate")
    parser.add_argument("--freq", type=str, default="1min", help="Frequency (e.g., 1min, 5min)")
    parser.add_argument("--output", type=str, default="assets/data/", help="Output directory")
    ...
    for asset in assets:
        ...
        # annual -> frequency
        dt = 1.0 / (365 * 24 * 60 / (int(args.freq.replace("min", "")) if args.freq.endswith("min") else 60))
