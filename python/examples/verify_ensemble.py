...
def verify_ensemble():
    ...
    configs = [
        {"name": "LSTM", "feature_dim": 10, "hidden_dim": 32, "num_layers": 1, "output_dim": 8, "seq_len": 20, "output_type": "prediction"},
        {"name": "LSTM", "feature_dim": 10, "hidden_dim": 64, "num_layers": 2, "output_dim": 8, "seq_len": 20, "output_type": "prediction"},
        {"name": "GRU", "feature_dim": 10, "hidden_dim": 48, "num_layers": 1, "output_dim": 8, "seq_len": 20, "output_type": "prediction"},
    ]
    ...
    weights = [0.5, 0.3, 0.2]
    weighted_ensemble = create_ensemble_from_configs(configs, strategy="weighted", weights=weights)
