...
def verify_maml_lightning():
    ...
    print(f"Created MAMLLightningModule with {sum(p.numel() for p in maml.parameters())} parameters")
    ...
    regime_datasets = {
        0: torch.randn(200, 10, 6),  # Regime 0: 200 samples, seq_len=10, 5 features + 1 target
