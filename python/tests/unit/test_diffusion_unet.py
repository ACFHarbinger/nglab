...
def test_diffusion_unet_1d_forward():
    ...
    model = DiffusionUNet1D(input_dim=feat, output_dim=feat, hidden_dim=32, layers=[1, 2])
...
def test_diffusion_unet_1d_with_condition():
    ...
    model = DiffusionUNet1D(input_dim=feat_x + feat_cond, output_dim=feat_x, hidden_dim=32)
