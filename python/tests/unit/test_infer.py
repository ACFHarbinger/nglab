...
def test_inference_script_success(mock_model_artifact):
    ...
    # Mock sys.argv
    test_args = ["infer.py", "--model_path", str(mock_model_artifact), "--input_json", input_json]
...
def test_inference_script_missing_model():
    ...
    input_json = "[1.0, 2.0]"
    test_args = ["infer.py", "--model_path", "/path/to/nonexistent/model.pt", "--input_json", input_json]
