...
def calculate_metrics(history: List[Dict[str, Any]], risk_free_rate: float = 0.0) -> Dict[str, float]:
    """
    ...
    sortino_ratio = (avg_return - risk_free_rate) / downside_std if downside_std > 0 else 0.0
