...
def train_ppo(args):
    ...
    if args.num_envs > 1:
        env = SubprocVecEnv([make_env(i, args.seed, args.lookback, args.max_steps) for i in range(args.num_envs)])
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="models/ppo_trading", help="Directory to save models")
