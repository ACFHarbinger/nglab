...
class GANLightningModule(pl.LightningModule):
    ...
    """
    def __init__(self, generator: nn.Module, discriminator: nn.Module, cfg: Dict[str, Any]):
        """
        ...
        self.lambda_l1 = cfg.get('lambda_l1', 100.0) # Reconstruction weight often high in cGAN (Pix2Pix style)
