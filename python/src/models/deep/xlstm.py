...
class xLSTM(nn.Module):
    ...
    """
    def __init__(self, input_dim, hidden_dim, n_layers, output_dim, dropout=0.0, output_type='prediction', cell_type='slstm', num_heads=4):
        """
        ...
        if isinstance(cell_type, str):
            ...
            assert len(cell_type) == n_layers, "cell_type list length must match n_layers"
