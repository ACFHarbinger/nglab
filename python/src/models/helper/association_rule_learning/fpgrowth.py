...
class FPGrowthAlgorithm:
    ...
    def _mine_tree(self, header_table, min_count, prefix, frequent_itemsets):
        ...
        for item in sorted_items:
            ...
            # Filter infrequent
            cond_header_table = {k: [v, None] for k, v in cond_header_table.items() if v >= min_count}
            ...
            if cond_header_table:
                ...
                for path, count in conditional_patterns:
                    ...
                    if frequent_path:
                        ...
                        self._insert_tree_with_count(frequent_path, count, cond_tree_root, cond_header_table)
