...
const Sparkline = ({ color = '#6366f1', data }: { color?: string, data: number[] }) => {
        ...
        <div className="flex flex-col gap-4 h-full">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <span className="text-sm font-bold uppercase tracking-wider text-slate-400">Market Overview</span>
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden">
                    <div className="relative z-10">
                        <div className="flex items-center gap-2 text-yellow-500 mb-1">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-wider">24h Volume</span>
                        </div>
                        <div className="text-xl font-mono font-bold text-white">$370.158M</div>
                    </div>
                    <div className="relative z-10 mt-2">
                        <Sparkline color="#eab308" data={[40, 35, 55, 45, 60, 75, 50, 65, 80, 70, 90, 85]} />
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden">
                    <div className="relative z-10">
                        <div className="flex items-center gap-2 text-cyan-400 mb-1">
                            <Users size={14} />
                            <span className="text-[10px] font-bold uppercase tracking-wider">24h Active Traders</span>
                        </div>
                        <div className="text-xl font-mono font-bold text-white">198,510</div>
                    </div>
                    <div className="relative z-10 mt-2">
                        <Sparkline color="#22d3ee" data={[20, 30, 25, 40, 35, 50, 45, 60, 55, 70, 65, 80]} />
                        <div className="flex justify-between text-[9px] text-slate-500 mt-1">
                            <span>00:00</span>
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden">
                    <div className="relative z-10">
                        <div className="flex items-center gap-2 text-purple-400 mb-1">
                            <Clock size={14} />
                            <span className="text-[10px] font-bold uppercase tracking-wider">Peak Hours</span>
                        </div>
                        <div className="text-xl font-mono font-bold text-white">20:00 UTC</div>
                    </div>
                    <div className="mt-2 flex items-end gap-0.5 h-10">
                        {[30, 45, 20, 60, 80, 100, 70, 50, 40, 60, 40, 30].map((h, i) => (
                            <div key={i} className="flex-1 bg-purple-500/30 hover:bg-purple-500 rounded-t-sm transition-colors" style={{ height: `${h}%` }} />
                        ))}
                    </div>
                    <div className="flex justify-between text-[9px] text-slate-500 mt-1">
                        <span>12PM</span>
            ...
            <div className="grid grid-cols-4 gap-4">
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-3">
                    <div className="flex items-center gap-2 text-slate-500 mb-1">
                        <Calendar size={12} />
                        <span className="text-[10px] font-bold uppercase tracking-wider">Closing Today</span>
                    </div>
                    <div className="flex items-baseline gap-2">
                        <span className="text-lg font-mono font-bold text-rose-400">1721</span>
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-3">
                    <div className="flex items-center gap-2 text-slate-500 mb-1">
                        <Activity size={12} />
                        <span className="text-[10px] font-bold uppercase tracking-wider">TQ Avg Volume</span>
                    </div>
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-3">
                    <div className="flex items-center gap-2 text-slate-500 mb-1">
                        <Users size={12} />
                        <span className="text-[10px] font-bold uppercase tracking-wider">TQ Avg Traders</span>
                    </div>
                    <div className="text-[10px] text-slate-600 font-bold uppercase">Coming Soon</div>
                </div>
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-3">
                    <div className="flex items-center gap-2 text-slate-500 mb-1">
                        <Zap size={12} />
                        <span className="text-[10px] font-bold uppercase tracking-wider">Market Flow</span>
                    </div>
                    <div className="grid grid-cols-3 gap-2 text-center">
                        ...
                        <div>
                            <div className="text-sm font-mono font-bold text-white">3010.0</div>
