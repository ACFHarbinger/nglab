...
export function UserProfileWidget() {
    ...
    useEffect(() => {
        ...
        const bottomColor = isProfit ? 'rgba(34, 197, 94, 0.0)' : 'rgba(239, 68, 68, 0.0)';
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4 border-t border-slate-800 pt-4">
                    <div className="flex justify-between items-center">
                        <div className="text-[10px] uppercase text-slate-500 font-semibold">Positions Value</div>
                        <div className="text-lg font-bold text-white">$828.93</div>
                    </div>
                    <div className="flex justify-between items-center">
                        <div className="text-[10px] uppercase text-slate-500 font-semibold">Biggest Win</div>
                        <div className="text-lg font-bold text-white">$170.40</div>
                    </div>
                    <div className="flex justify-between items-center">
                        <div className="text-[10px] uppercase text-slate-500 font-semibold">Predictions</div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex-1 flex flex-col">
                <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-slate-400 text-sm font-medium">Profit/Loss</span>
                    </div>
                    <div className="flex bg-slate-800 rounded p-0.5">
                        <button className="px-2 py-0.5 text-[10px] font-medium text-slate-400 hover:text-white">1D</button>
                        <button className="px-2 py-0.5 text-[10px] font-medium bg-slate-700 text-white rounded shadow-sm">1W</button>
                        <button className="px-2 py-0.5 text-[10px] font-medium text-slate-400 hover:text-white">1M</button>
                        <button className="px-2 py-0.5 text-[10px] font-medium text-slate-400 hover:text-white">ALL</button>
                    </div>
                </div>

                <div className="flex items-baseline gap-2 mb-1">
                    <h2 className="text-3xl font-bold text-white">-$9.30</h2>
                    <span className="text-slate-500 text-xs bg-slate-800 px-1.5 py-0.5 rounded-full cursor-help">i</span>
                </div>
                ...
                <div className="flex justify-end mt-2">
                    <div className="text-slate-600 text-xs font-semibold flex items-center gap-1">
                        <svg className="w-4 h-4 opacity-50" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 22H22L12 2Z" /></svg>
                        Polymarket
                    </div>
                </div>
            </div>
