            ...
            <div className="flex border-b border-slate-800">
                <button
                    ...
                    className={clsx(
                        ...
                        side === 'buy' ? "bg-emerald-600/10 text-emerald-400 border-b-2 border-emerald-500" : "text-slate-500 hover:text-slate-300 hover:bg-slate-800/50"
                    )}
                >
                    Buy
                </button>
                <button
                    ...
                    className={clsx(
                        "flex-1 py-3 text-sm font-bold uppercase tracking-wide transition-colors",
                        side === 'sell' ? "bg-rose-600/10 text-rose-400 border-b-2 border-rose-500" : "text-slate-500 hover:text-slate-300 hover:bg-slate-800/50"
                    )}
                >
                    Sell
                </button>
            ...
            <div className="p-4 flex flex-col gap-4 flex-1">
                ...
                <div className="space-y-1">
                    <div className="flex justify-between text-xs text-slate-400">
                        ...
                        <span className="text-indigo-400 cursor-pointer hover:underline">Market</span>
                    </div>
                    <div className="relative">
                        ...
                        />
                        <span className="absolute left-3 top-2.5 text-slate-500 text-sm">USDC</span>
                    </div>
                </div>
                ...
                <div className="space-y-1">
                    <div className="flex justify-between text-xs text-slate-400">
                        ...
                        <div className="flex items-center gap-1">
                            <Wallet size={10} />
                            <span>{side === 'buy' ? `${maxBuy.toFixed(2)} USDC` : `${maxSell} Shares`}</span>
                        </div>
                    </div>
                    <div className="relative">
                        <input
                ...
                <div className="bg-slate-950/50 rounded-lg p-3 space-y-2 border border-slate-800/50 mt-2">
                    <div className="flex justify-between text-xs">
                        ...
                        <span className="font-mono text-slate-200">{estimatedShares.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-xs">
                        <span className="text-slate-500 flex items-center gap-1">Fee <Info size={10} /></span>
                    ...
                    <div className="flex justify-between text-xs pt-2 border-t border-slate-800/50">
                        ...
                        <span className="font-mono text-white text-sm font-bold">${parsedAmount.toFixed(2)}</span>
                    </div>
                </div>
